...
-- Discord: https://discord.gg/5pscTe2AkW
...
local Window = Rayfield:CreateWindow({
    Name = "Dexter Hub | Arsenal (Merged)",
    LoadingTitle = "Dexter Hub",
...
TabMisc:CreateButton({ Name = "Discord (copy invite)", Callback = function()
    local invite = "https://discord.gg/5pscTe2AkW"
...
-- Final startup
updateHighlightsState()
print("Merged Dexter Hub | Arsenal + Weapon Enhancements loaded. Rayfield GUI active. (Fixed Infinite Ammo auto-refill)")
